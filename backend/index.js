...
//http://localhost:3000/backend/clientes/5e74f6d7cb397de0be345b20
app.get('/backend/clientes/:id', function(req, res) {
...
app.get('/backend/clientes', function (req, res) {
  ...
  let jsonData = require('../customers.json');
   ...
   var cliente = jsonData.map(v => {
    ...
    //acessar a URL http://localhost:3000/backend/clientes?nome=ali
    ...
    //acessar a URL http://localhost:3000/backend/clientes?pegaDetalhes=cox
    ...
    var items = cliente;
    //acessar a URL http://localhost:3000/backend/clientes?pagina=1
    function Paginator(items, page, per_page) {
      ...
      //http://localhost:3000/backend/clientes?pagina=1&sort=asc
      if( vSort == 'asc' ) {
      ...
      //http://localhost:3000/backend/clientes?pagina=1&sort=desc  
      } else if(vSort == 'desc' ) {
        var myArray = myPage.sort(function(a,b) {
          return a.Nome > b.Nome ? -1 : a.Nome < b.Nome ? 1 : 0;
        });
